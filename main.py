...
def attack(char_name: str, char_class: str) -> str:
    """Calculate the damage dealt by a character in an attack.
    ...
    Returns:
        str: A string describing the damage dealt by the character.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Generate a defence message based on the character's class.
...
def special(char_name: str, char_class: str) -> str:
    """
    Return a string with the character's special ability based on their class.
    ...
    Returns:
        str: A string with the character's special ability.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Returns:
        str: A message indicating the end of the training.
    """
    if char_class == 'warrior':
